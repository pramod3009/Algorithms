...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.columnconfigure(10, pad=180)
        ...
        self.obtn.grid(row=10, column=4,columnspan=3,sticky=W)
    ...
    def contains(self):
        ...
        for i in ['dfs','depth']:
            if i in input:
                ...
                return
        for i in ['dijkstra','uniform cost search','ucs','only path lengths']:
            if i in input:
                self.controller.show_frame("PageFour")
                return
        for i in ['astar','A*','a*','path length', 'heuristic function']:
            if i in input:
