...
def astar(graph, initial_node, goal_node, h):
    ...
    h_score = {initial_node: 0,(1,0):15,(2,2):4,(0,1):2,(1,1):3,(5,1):2.5,(3,1):2}  # heuristic estimate
...
def start(x1,y1,x2,y2):
    ...
    g.add_edge((2,2),(3,1),0.5)
    g.add_edge((1,0),(3,1),1.5)
    g.add_edge((0,1),(5,1),0.7)
    g.add_edge((2,2),(5,1),1.2)
    return shortest_path(g, (x1, y1), (x2, y2), sldist)
